...
{
    id: 'blog-11',
    title: '使用 yuleASR 配置器搭建 AutoSAR BSW 项目',
    desc: '使用 yuleASR 在线配置器完成 AutoSAR BSW 项目的模块选择、配置和代码生成。',
    author: '予乐编辑部',
    avatar: '予乐',
    role: 'YuleTech',
    date: '2026-07-20',
    ...
    likes: 45,
    comments: 12,
    tags: ['工具链', 'yuleASR', '配置器'],
    category: '工具链',
    hot: true,
    content: 'yuleASR 配置器是 YuleTech 推出的在线 AutoSAR BSW 配置工具。选择芯片后自动筛选 MCAL 模块，可视化配置 MCAL 时钟和引脚、ECUAL 通道和模式、Service NVM 策略等参数，一键生成 yuleASR_config.h 头文件。',
  },
  {
    id: 'blog-12',
    title: 'SPI 驱动从零配置：基于 STM32H743 的 MCAL 实战',
    desc: '以 STM32H743 为例讲解 SPI 外设的 MCAL 驱动配置流程。',
    author: '陈嵌',
    avatar: '陈嵌',
    role: '嵌入式工程师',
    date: '2026-07-18',
    ...
    category: 'MCAL',
    hot: true,
    content: 'STM32H743 有 6 个 SPI 外设支持 100MHz 和 DMA。MCAL 配置分四步：1）Mcu 时钟配置；2）Port 引脚复用；3）SPI 控制器参数；4）DMA 通道配置。通过 yuleASR 配置器一键生成头文件。',
  },
  {
    id: 'blog-13',
    title: 'AutoSAR 通信栈配置：从 CanIf 到 PduR 的完整链路',
    desc: '解读 AutoSAR 通信栈中 CanIf、CanTp、PduR 和 Com 模块的配置要点。',
    author: '王通',
    avatar: '王通',
    role: '通信专家',
    date: '2026-07-15',
    ...
    category: 'ECUAL',
    hot: false,
    content: 'AutoSAR 通信栈分层：SWC 到 CAN。Can 负责位时序，CanIf 提供 PDU 抽象，CanTp 处理分包，PduR 支持路由，Com 提供信号级接口。社区模板只需配置波特率等参数即可生成完整通信栈。',
  },
];
