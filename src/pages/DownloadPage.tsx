...
const downloadItems: DownloadItem[] = [
  ...
  },
  {
    ...
    version: 'v13.2.rel1',
    size: '280 MB',
    description: '适用于 i.MX8M Mini 的 ARM GCC 交叉编译工具链，支持 AArch64 和 ARMv7-A。',
    category: '工具链',
  },
  {
    id: 'dl-3',
    ...
    version: 'v2026.04',
    size: '1.2 GB',
    description: 'i.MX8M Mini 调试器软件套件，包含 JTAG 调试脚本和 Flash 编程工具。',
    category: '工具链',
  },
  {
    id: 'dl-4',
    name: 'i.MX8M Mini Reference Manual',
    version: 'Rev. 3',
    size: '45 MB',
    description: 'NXP i.MX8M Mini 处理器完整参考手册，涵盖所有外设寄存器详细说明。',
    category: '手册',
  },
  {
    id: 'dl-5',
    name: 'i.MX8M Mini Datasheet',
    version: 'Rev. 2.1',
    size: '8 MB',
    description: 'i.MX8M Mini 芯片数据手册，包含电气特性、引脚定义和封装信息。',
    category: '手册',
  },
  {
    id: 'dl-6',
