  ...
  return (
    <div className="min-h-screen pt-16">
      <Helmet>
        ...
        <meta name="description" content="基于 AutoSAR Classic Platform 4.x 标准，为全球主流处理器构建完整的 BSW 栈。从底层驱动到应用组件，全部开源，永久免费。" />
      </Helmet>
      {/* Hero */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto mb-8">
              基于 AutoSAR Classic Platform 4.x 标准，为全球主流处理器构建完整的 BSW 栈。
