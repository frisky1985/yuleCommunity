...
- Name: core.spec.ts >> yuleCommunity Core Paths >> module compare page with query params
- Location: e2e/core.spec.ts:28:3
...
Call log:
  ...
  - waiting for getByText('对比')

```

```yaml
- text: The server is configured with a public base URL of /yuleCommunity/ - did you mean to visit
- link "/yuleCommunity/compare?modules=MCU,SPI":
  - /url: /yuleCommunity/compare?modules=MCU,SPI
- text: instead?
```
