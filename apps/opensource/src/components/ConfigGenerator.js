...
import { Code, Cpu, Layers, Database, Settings, Copy, Download, CheckCircle2, Play, ChevronDown, Wrench, } from 'lucide-react';
const mcalModules = [
    {
        id: 'mcu',
        name: 'Mcu (微控制器驱动)',
...
export function ConfigGenerator() {
    ...
    return (_jsx("section", { className: "py-16 bg-card/30 border-y border-border", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [_jsxs("div", { className: "text-center mb-10", children: [_jsxs("span", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[hsl(var(--accent))]/10 text-[hsl(var(--accent))] text-sm font-medium mb-4", children: [_jsx(Settings, { className: "w-4 h-4" }), "\u5728\u7EBF\u914D\u7F6E\u5DE5\u5177"] }), _jsx("h2", { className: "text-3xl font-bold mb-3", children: "\u53EF\u89C6\u5316\u914D\u7F6E\u751F\u6210\u5668" }), _jsx("p", { className: "text-muted-foreground max-w-2xl mx-auto", children: "\u901A\u8FC7\u56FE\u5F62\u5316\u754C\u9762\u914D\u7F6E MCAL \u9A71\u52A8\u548C BSW \u6A21\u5757\u53C2\u6570\uFF0C\u4E00\u952E\u751F\u6210\u7B26\u5408 AutoSAR \u6807\u51C6\u7684 C \u8BED\u8A00\u914D\u7F6E\u5934\u6587\u4EF6\uFF0C\u76F4\u63A5\u96C6\u6210\u5230\u60A8\u7684\u9879\u76EE\u4E2D\u3002" })] }), _jsx("div", { className: "flex justify-center mb-8", children: _jsxs("div", { className: "inline-flex bg-muted rounded-xl p-1", children: [_jsxs("button", { onClick: () => { setActiveTab('mcal'); setGeneratedCode(''); }, className: `flex items-center gap-2 px-6 py-2.5 rounded-lg text-sm font-medium transition-all ${activeTab === 'mcal'
                                    ? 'bg-[hsl(var(--primary))] text-primary-foreground shadow-sm'
                                    : 'text-muted-foreground hover:text-foreground'}`, children: [_jsx(Cpu, { className: "w-4 h-4" }), "MCAL \u914D\u7F6E"] }), _jsxs("button", { onClick: () => { setActiveTab('bsw'); setGeneratedCode(''); }, className: `flex items-center gap-2 px-6 py-2.5 rounded-lg text-sm font-medium transition-all ${activeTab === 'bsw'
                                    ? 'bg-[hsl(var(--primary))] text-primary-foreground shadow-sm'
                                    : 'text-muted-foreground hover:text-foreground'}`, children: [_jsx(Database, { className: "w-4 h-4" }), "BSW \u914D\u7F6E"] })] }) }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [_jsx("div", { className: "bg-card border border-border rounded-2xl p-6", children: activeTab === 'mcal' ? (_jsxs(_Fragment, { children: [_jsxs("div", { className: "mb-6", children: [_jsx("label", { className: "block text-sm font-medium mb-3", children: "\u9009\u62E9 MCAL \u6A21\u5757" }), _jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-2", children: mcalModules.map((mod) => (_jsxs("button", { onClick: () => setSelectedMcalModule(mod.id), className: `flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-all ${selectedMcalModule === mod.id
                                                        ? 'bg-[hsl(var(--primary))] text-primary-foreground'
                                                        : 'bg-muted text-muted-foreground hover:text-foreground'}`, children: [_jsx(mod.icon, { className: "w-4 h-4" }), _jsx("span", { className: "truncate", children: mod.name.split(' ')[0] })] }, mod.id))) })] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-2 pb-3 border-b border-border", children: [_jsx(currentMcalModule.icon, { className: "w-5 h-5 text-[hsl(var(--accent))]" }), _jsx("h3", { className: "font-semibold", children: currentMcalModule.name })] }), currentMcalModule.params.map((param) => (_jsxs("div", { className: "space-y-1.5", children: [_jsx("label", { className: "text-sm font-medium", children: param.label }), param.type === 'select' ? (_jsxs("div", { className: "relative", children: [_jsx("select", { value: String(mcalValues[selectedMcalModule]?.[param.name] ?? param.defaultValue), onChange: (e) => handleMcalChange(param.name, e.target.value), className: "w-full px-3 py-2 rounded-lg bg-muted border border-border text-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[hsl(var(--accent))]/50", children: param.options?.map((opt) => (_jsx("option", { value: opt, children: opt }, opt))) }), _jsx(ChevronDown, { className: "absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground pointer-events-none" })] })) : param.type === 'boolean' ? (_jsx("button", { onClick: () => handleMcalChange(param.name, !mcalValues[selectedMcalModule]?.[param.name]), className: `w-full px-3 py-2 rounded-lg text-sm font-medium transition-all ${mcalValues[selectedMcalModule]?.[param.name]
                                                            ? 'bg-emerald-500/10 text-emerald-500 border border-emerald-500/20'
                                                            : 'bg-muted text-muted-foreground border border-border'}`, children: mcalValues[selectedMcalModule]?.[param.name] ? '已启用' : '已禁用' })) : (_jsx("input", { type: param.type === 'number' ? 'number' : 'text', value: String(mcalValues[selectedMcalModule]?.[param.name] ?? ''), onChange: (e) => handleMcalChange(param.name, param.type === 'number' ? Number(e.target.value) : e.target.value), className: "w-full px-3 py-2 rounded-lg bg-muted border border-border text-sm focus:outline-none focus:ring-2 focus:ring-[hsl(var(--accent))]/50" })), _jsx("p", { className: "text-xs text-muted-foreground", children: param.desc })] }, param.name)))] }), _jsxs("button", { onClick: handleGenerateMcal, className: "w-full mt-6 flex items-center justify-center gap-2 px-4 py-3 bg-[hsl(var(--primary))] text-primary-foreground rounded-xl font-medium hover:bg-[hsl(var(--primary-glow))] transition-all", children: [_jsx(Play, { className: "w-4 h-4" }), "\u751F\u6210\u914D\u7F6E\u4EE3\u7801"] })] })) : (_jsxs(_Fragment, { children: [_jsxs("div", { className: "mb-6", children: [_jsx("label", { className: "block text-sm font-medium mb-3", children: "\u9009\u62E9 BSW \u6A21\u5757" }), _jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-2", children: bswModules.map((mod) => (_jsxs("button", { onClick: () => setSelectedBswModule(mod.id), className: `flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-all ${selectedBswModule === mod.id
                                                        ? 'bg-[hsl(var(--primary))] text-primary-foreground'
                                                        : 'bg-muted text-muted-foreground hover:text-foreground'}`, children: [_jsx(mod.icon, { className: "w-4 h-4" }), _jsx("span", { className: "truncate", children: mod.name.split(' ')[0] })] }, mod.id))) })] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-2 pb-3 border-b border-border", children: [_jsx(currentBswModule.icon, { className: "w-5 h-5 text-[hsl(var(--accent))]" }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold", children: currentBswModule.name }), _jsxs("span", { className: "text-xs text-muted-foreground", children: [currentBswModule.layer, " Layer"] })] })] }), currentBswModule.params.map((param) => (_jsxs("div", { className: "space-y-1.5", children: [_jsx("label", { className: "text-sm font-medium", children: param.label }), param.type === 'select' ? (_jsxs("div", { className: "relative", children: [_jsx("select", { value: String(bswValues[selectedBswModule]?.[param.name] ?? param.defaultValue), onChange: (e) => handleBswChange(param.name, e.target.value), className: "w-full px-3 py-2 rounded-lg bg-muted border border-border text-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[hsl(var(--accent))]/50", children: param.options?.map((opt) => (_jsx("option", { value: opt, children: opt }, opt))) }), _jsx(ChevronDown, { className: "absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground pointer-events-none" })] })) : param.type === 'boolean' ? (_jsx("button", { onClick: () => handleBswChange(param.name, !bswValues[selectedBswModule]?.[param.name]), className: `w-full px-3 py-2 rounded-lg text-sm font-medium transition-all ${bswValues[selectedBswModule]?.[param.name]
                                                            ? 'bg-emerald-500/10 text-emerald-500 border border-emerald-500/20'
                                                            : 'bg-muted text-muted-foreground border border-border'}`, children: bswValues[selectedBswModule]?.[param.name] ? '已启用' : '已禁用' })) : (_jsx("input", { type: param.type === 'number' ? 'number' : 'text', value: String(bswValues[selectedBswModule]?.[param.name] ?? ''), onChange: (e) => handleBswChange(param.name, param.type === 'number' ? Number(e.target.value) : e.target.value), className: "w-full px-3 py-2 rounded-lg bg-muted border border-border text-sm focus:outline-none focus:ring-2 focus:ring-[hsl(var(--accent))]/50" })), _jsx("p", { className: "text-xs text-muted-foreground", children: param.desc })] }, param.name)))] }), _jsxs("button", { onClick: handleGenerateBsw, className: "w-full mt-6 flex items-center justify-center gap-2 px-4 py-3 bg-[hsl(var(--primary))] text-primary-foreground rounded-xl font-medium hover:bg-[hsl(var(--primary-glow))] transition-all", children: [_jsx(Play, { className: "w-4 h-4" }), "\u751F\u6210\u914D\u7F6E\u4EE3\u7801"] })] })) }), _jsxs("div", { className: "bg-card border border-border rounded-2xl p-6", children: [_jsxs("div", { className: "flex items-center justify-between mb-4", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx(Code, { className: "w-5 h-5 text-[hsl(var(--accent))]" }), _jsx("h3", { className: "font-semibold", children: "\u751F\u6210\u7684\u914D\u7F6E\u4EE3\u7801" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsxs("button", { onClick: handleCopy, disabled: !generatedCode, className: "flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-muted text-sm font-medium hover:bg-muted/80 transition-all disabled:opacity-50 disabled:cursor-not-allowed", children: [copied ? _jsx(CheckCircle2, { className: "w-4 h-4 text-emerald-500" }) : _jsx(Copy, { className: "w-4 h-4" }), copied ? '已复制' : '复制'] }), _jsxs("button", { onClick: handleDownload, disabled: !generatedCode, className: "flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[hsl(var(--primary))] text-primary-foreground text-sm font-medium hover:bg-[hsl(var(--primary-glow))] transition-all disabled:opacity-50 disabled:cursor-not-allowed", children: [_jsx(Download, { className: "w-4 h-4" }), "\u4E0B\u8F7D"] })] })] }), _jsx("div", { className: "relative", children: _jsx("pre", { className: "h-[500px] overflow-auto bg-muted rounded-xl p-4 text-xs font-mono text-foreground", children: generatedCode || (_jsx("span", { className: "text-muted-foreground", children: `/* \u70b9\u51fb\u300c\u751f\u6210\u914d\u7f6e\u4ee3\u7801\u300d\u6309\u94ae\u67e5\u770b\u751f\u6210\u7684 C \u5934\u6587\u4ef6 */
