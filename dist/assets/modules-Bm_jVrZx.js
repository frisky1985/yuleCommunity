...
}`,codeLanguage:"c",changelog:[{version:"v1.2.0",date:"2026-04-20",changes:["新增动态时钟门控支持","优化 STOP 模式恢复时间"]},{version:"v1.1.0",date:"2026-03-15",changes:["增加复位原因诊断接口","修复 PLL 锁定检测偶发失效"]},{version:"v1.0.0",date:"2026-01-10",changes:["初始版本发布","支持基础时钟配置"]}]},Port:{id:"port",name:"Port",layer:"MCAL",status:"已完成",version:"v1.1.0",stars:42,forks:10,shortDesc:"端口驱动，配置引脚功能和方向",overview:"Port 驱动负责配置微控制器引脚的功能复用、方向（输入/输出）、驱动能力和上下拉电阻，支持 128 个可配置引脚。",features:["引脚功能复用配置 (MUX_MODE)","输入/输出方向控制","内部上下拉电阻配置","驱动强度与压摆率设置","数字输入滤波器","引脚锁定保护机制"],apis:[{name:"Port_Init",params:"const Port_ConfigType* ConfigPtr",returns:"void",desc:"初始化 Port 模块，应用所有引脚配置"},{name:"Port_SetPinDirection",params:"Port_PinType Pin, Port_PinDirectionType Direction",returns:"void",desc:"运行时设置引脚方向"},{name:"Port_RefreshPortDirection",params:"void",returns:"void",desc:"刷新引脚方向为配置值"},{name:"Port_SetPinMode",params:"Port_PinType Pin, Port_PinModeType Mode",returns:"void",desc:"设置引脚功能复用模式"}],configs:[{name:"PortPinMode",type:"Port_PinModeType",desc:"引脚复用功能选择",default:"PORT_PIN_MODE_DIO"},{name:"PortPinDirection",type:"Port_PinDirectionType",desc:"引脚方向",default:"PORT_PIN_IN"},{name:"PortPinLevelValue",type:"Port_PinLevelValueType",desc:"初始电平",default:"PORT_PIN_LEVEL_LOW"}],dependencies:["Det (开发时)"],codeExample:`/* Port 引脚配置示例 */
#include "Port.h"
...
}`,codeLanguage:"c",changelog:[{version:"v1.0.0",date:"2026-03-01",changes:["初始版本发布"]}]}},t={CanIf:{id:"canif",name:"CanIf",layer:"ECUAL",status:"已完成",version:"v1.2.0",stars:52,forks:14,shortDesc:"CAN接口层，统一管理CAN通信",overview:"CanIf (CAN Interface) 是 ECUAL 层的核心通信接口，为上层模块提供统一的 CAN 报文收发服务，屏蔽底层 Can 驱动的硬件差异。",features:["统一 PDU 收发接口","多控制器管理","发送确认/接收指示回调","控制器模式管理 (Started/Stopped/Sleep)","报文过滤配置","总线关闭通知"],apis:[{name:"CanIf_Init",params:"const CanIf_ConfigType* ConfigPtr",returns:"void",desc:"初始化 CanIf 模块"},{name:"CanIf_Transmit",params:"PduIdType TxPduId, const PduInfoType* PduInfoPtr",returns:"Std_ReturnType",desc:"发送 PDU"},{name:"CanIf_SetControllerMode",params:"uint8 Controller, CanIf_ControllerModeType ControllerMode",returns:"Std_ReturnType",desc:"设置控制器模式"}],configs:[{name:"CanIfHthCfg",type:"CanIf_HthConfigType",desc:"发送硬件句柄配置",default:"见 CanIf_Cfg.c"},{name:"CanIfRxPduCfg",type:"CanIf_RxPduConfigType",desc:"接收 PDU 配置",default:"见 CanIf_Cfg.c"}],dependencies:["Can","PduR","Com","CanTp"],codeExample:`/* CanIf 发送示例 */
#include "CanIf.h"
