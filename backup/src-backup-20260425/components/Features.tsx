import { Code2, Wrench, BookOpen, Cpu } from 'lucide-react';
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <button className="mt-4 text-sm font-medium text-[hsl(var(--accent))] hover:text-[hsl(var(--accent-glow))] transition-colors flex items-center gap-1 group/btn">
                  了解更多
