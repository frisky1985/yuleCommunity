...
import { O as OpenSourcePage, T as ToolchainPage } from './ToolchainPage-DAbuwoSR.js';
...
const routes = [
    {
        path: '/opensource',
        element: jsxRuntimeExports.jsx(OpenSourcePage, {}),
    },
    {
        path: '/opensource/*',
        element: jsxRuntimeExports.jsx(OpenSourcePage, {}),
    ...
    {
        path: '/toolchain',
        element: jsxRuntimeExports.jsx(ToolchainPage, {}),
    },
    {
        path: '/toolchain/*',
        element: jsxRuntimeExports.jsx(ToolchainPage, {}),
...
function App() {
    return (jsxRuntimeExports.jsx(Routes, { children: routes.map((route) => (jsxRuntimeExports.jsx(Route, { path: route.path, element: route.element }, route.path))) }));
}
