...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-D6ThYWTZ.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-CK9hJ8lQ.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-DwJnhtOo.js', import.meta.url).href),import:true},'lucide-react':{get:()=>()=>__federation_import(new URL('__federation_shared_lucide-react-6J9WzVD5.js', import.meta.url).href),import:true},'react-syntax-highlighter':{get:()=>()=>__federation_import(new URL('__federation_shared_react-syntax-highlighter-DQPVdSMD.js', import.meta.url).href),import:true},'react-helmet-async':{get:()=>()=>__federation_import(new URL('__federation_shared_react-helmet-async-k8svLhhG.js', import.meta.url).href),import:true}};
