...
const {useState,useEffect,useCallback: useCallback$2} = await importShared('react');
...
function useLocalStorage(key, initialValue) {
    ...
    const setValue = useCallback$2((value) => {
        setStoredValue((prev) => {
...
function migrateForumPosts(posts) {
...
function useUserSystem() {
    ...
    const addPoints = useCallback$1((action, description) => {
    ...
    const setPoints = useCallback$1((points) => {
        setState((prev) => ({
            ...prev,
...
export { useUserSystem as a, useNotifications as b, initialQuestions as c, initialEvents as d, generateId as g, initialForumPosts as i, migrateForumPosts as m, useLocalStorage as u };
